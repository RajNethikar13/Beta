    ...
    <section >
        ...
        <div class="wrapper">
            ...
            <div class="header">
              ...
              <div class="sid">
              <form method="POST"  enctype="multipart/form-data" action="clav1.php">
         ...
                  </form>
              ...
              <div id="dataContainer">
                <h4 style="margin: 10px;">Select the Variant</h4>
                   <ul id="sr">
                    <li><a href="Clavulanate/Clavulanate_Cep-01.html">CepA-01</a></li>
    ...
    for ($a = 2; $a < count($files); $a++)
    {
        ...
        <p>
            ...
            <script>
                ...
                td1.href="clav-data/<?php echo $files[$a]; ?>";
                 td1.target="_blank";
