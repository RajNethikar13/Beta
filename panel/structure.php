        ...
        <div class="wrapper">
            ...
            <div class="header">
              <ul class="nav nav-tabs" id="myTab" >
                ...
                <a href="../struct/Retrieved.php" class="subpanel">   <button class="nav-link " >Retrieved</button>    </a> 
                </li>
                <li class="nav-item" role="presentation">
                  <a href="../struct/modelled.php" class="subpanel"><button class="nav-link " >Modelled</button></a>
                </li>
                <li class="nav-item" role="presentation">
                 <a href="../struct/Energy Minimization.php" class="subpanel" > <button class="nav-link " >Energy Minimization</button>
                 </li></a>
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" href="#" id="validationDropdown" style="color: #0D6EFD;" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    Validation
                  </a>
                  <ul class="dropdown-menu" aria-labelledby="validationDropdown">
                    <li><a class="dropdown-item" href="../struct/ram.php">Ram Plot</a></li>
                    <li><a class="dropdown-item" href="../struct/rmsd.php">RMSD</a></li>
                   
                  </ul>
                </li>
                <li class="nav-item" role="presentation">
                    <a  href="../struct/Conservation Pattern.php"  class="subpanel" ><button class="nav-link " >Conservation Pattern</button></a>
                  </li>
