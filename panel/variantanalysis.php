        ...
        <div class="wrapper">
            ...
            <div class="header">
              <ul class="nav nav-tabs" id="myTab" >
                ...
                <a href="../variant/landscape.php" class="subpanel">   <button class="nav-link " >Landscape</button>    </a> 
                </li>
                <li class="nav-item" role="presentation">
                  <a href="../variant/common.php" class="subpanel"><button class="nav-link " >Common</button></a>
                </li>
                <li class="nav-item" role="presentation">
                 <a href="../variant/exclusive.php" class="subpanel" > <button class="nav-link " >Exclusive</button>
                 </li></a>
